...
public class VileCannon : Weapon {
	...
	public VileCannon(VileCannonType vileCannonType) : base() {
		index = (int)WeaponIds.VileCannon;
	...
	public VileCannonProj(
		...
		switch (weapon.type) {
			...
			case (int)VileCannonType.FatBoy:
				...
				fadeSprite = "vile_mk2_fb_proj_fade";
				damager = new Damager(player, 3, Global.halfFlinch, 0);
				xScale = xDir;
				maxTime = 0.45f;
				break;
			case (int)VileCannonType.FireMurrain:
				projId = (int)ProjIds.FireMurrain;
				weapon = VileCannon.netWeaponFM;
				damager = new Damager(player, 2, Global.halfFlinch, 0);
				break;
			case (int)VileCannonType.LongshotGizmo:
				...
				sprite = "vile_mk2_fb_proj";
				fadeSprite = "vile_mk2_fb_proj_fade";
				damager = new Damager(player, 0.5f, Global.miniFlinch, 0);
				break;
		}
